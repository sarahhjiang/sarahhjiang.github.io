      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Timeline line (put behind the dots) */}
            <div className="hidden md:block absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-accent to-secondary z-0" />
              ...
              {experiences.map((exp, index) => {
                ...
                return (
                  <div key={index} className="relative flex gap-8 group">
                    {/* Timeline dot */}
                    <div className="hidden md:flex items-start pt-1 relative z-10">
                      <div
                        className={cn(
